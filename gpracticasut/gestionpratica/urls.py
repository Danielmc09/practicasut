...
urlpatterns = [
    ...
    path('docentepracticanuevo/<int:pk>/<int:pers>/<int:pege>', DocentePractica.as_view(), name = 'docentepractica_crear'),
    ...
    path('auxiliarpracticanuevo/<int:pk>/<int:pers>/<int:pege>', AuxiliarPractica.as_view(), name = 'auxiliarpractica_crear'),
    ...
    path('conductorpracticanuevo/<int:pk>/<int:pers>/<int:pege>', ConductorPractica.as_view(), name = 'conductorpractica_crear'),
    ...
    path('materiaspracticanuevo/<int:pk>/<codigomateria>', MateriasPracticaCrear.as_view(), name = 'materiaspractica_crear'),
